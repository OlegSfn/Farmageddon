...
namespace Player.PlayerStates
{
    ...
    public class PlayerTakingDamageState : PlayerBaseState
    {
        ...
        public PlayerTakingDamageState(PlayerController playerController, Animator animator, Animator toolAnimator, Rigidbody2D rigidbody2D) : base(playerController, animator, toolAnimator, rigidbody2D)
        {
        }
        ...
        {
            Vector2 selfPosition = PlayerController.transform.position;
        ...
        {
            Vector3 knockBackDirection = ((Vector2)PlayerController.transform.position - HitInfo.HitPoint).normalized;
            knockBackPosition = PlayerController.transform.position + KnockBackDistance * knockBackDirection;
        }
