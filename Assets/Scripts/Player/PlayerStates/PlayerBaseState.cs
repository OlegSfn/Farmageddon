...
namespace Player.PlayerStates
{
    ...
    public abstract class PlayerBaseState : IState
    {
        ...
        protected PlayerBaseState(PlayerController playerController, Animator animator, Animator toolAnimator, Rigidbody2D rigidbody2D)
        {
        ...
        {
            if (PlayerController.IsTakingDamage || !PlayerController.IsAlive || GameManager.Instance.IsPaused)
            {
                return;
            }
        ...
        {
            Animator.SetFloat(VelX, PlayerController.Input.x);
            Animator.SetFloat(VelY, PlayerController.Input.y);
            Animator.SetFloat(LookDirXHash, PlayerController.LookDirection.x);
            Animator.SetFloat(LookDirYHash, PlayerController.LookDirection.y);
            
            ToolAnimator.SetFloat(LookDirXHash, PlayerController.LookDirection.x);
            ToolAnimator.SetFloat(LookDirYHash, PlayerController.LookDirection.y);
        }
