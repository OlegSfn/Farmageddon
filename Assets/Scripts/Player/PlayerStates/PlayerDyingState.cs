...
namespace Player.PlayerStates
{
    ...
    public class PlayerDyingState : PlayerBaseState
    {
        ...
        public PlayerDyingState(PlayerController playerController, Animator animator, Animator toolAnimator, Rigidbody2D rigidbody2D) : base(playerController, animator, toolAnimator, rigidbody2D)
        {
        }
